...
const std::string_view SCRIPTOBJ_NAME_NONE             = "<No Name>";
const std::string_view SCRIPTOBJ_DESCRIPTION_NONE_NAME = "<No Description>";
const std::string_view SCRIPTCATEGORY_NONE_NAME        = "<No Category>";
const std::string_view SCRIPTSUBSECTION_NONE_NAME      = "<No Subsection>";
...
{
public:
    ScriptSubsection(std::string_view subsectionName);
    ~ScriptSubsection();
...
{
public:
    ScriptCategory(std::string_view categoryName);
    ~ScriptCategory();
    std::string m_categoryName;
    std::vector<ScriptSubsection*> m_subsections;
    ScriptSubsection *findSubsection(std::string_view subsectionName, bool createNew = true);
};
...
public:
    ...
    ScriptCategory *findCategory(std::string_view categoryName, bool createNew = true); // createNew: create a new category if one named categoryName doesn't exist.
