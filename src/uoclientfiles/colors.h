...
class ARGB16;
class ARGB32;
ARGB32 convert_ARGB16_to_ARGB32(const ARGB16 argb16, bool maxOpacity = true);
ARGB16 convert_ARGB32_to_ARGB16(const ARGB32 argb32, bool maxOpacity = true);
...
public:
    ...
    inline void setVal(unsigned short val) {
        m_color = val & 0xFFFF;
    }
    ...
    ARGB16(unsigned short a, unsigned short r, unsigned short g, unsigned short b) {
        m_color = static_cast<unsigned short>((b & 0x1F) | ((g & 0x1F) << 5) | ((r & 0x1F) << 10) | ((a & 0x1F) << 15));
    }
    ARGB16& operator= (unsigned short color16) {
        this->setVal(color16);
        return *this;
    }
...
public:
    ...
    ARGB32& operator= (unsigned int color32) {
        this->setVal(color32);
        return *this;
    }
